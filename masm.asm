...
printf proto C fmtStr: dword, args: vararg
...
;---------------------------------------------------
.code
MyPrintf proc C format: dword, args: vararg	

	mov ebx, args
	invoke printf, format, ebx
